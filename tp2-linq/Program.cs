...
namespace tp2_linq
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var auteurPlusProlifique = ListeLivres.GroupBy(l => l.Auteur).OrderByDescending(g => g.Count()).FirstOrDefault().Key;
            Console.WriteLine($"Auteur le plus prolifique : {auteurPlusProlifique.Prenom} {auteurPlusProlifique.Nom}\n");
